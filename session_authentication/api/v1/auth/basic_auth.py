#!/usr/bin/env python3
"""Module defines the auth class for handling basic authentication. P"""
...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(
        ...
        """The Base64 encoded part of the header."""
    ...
    def extract_user_credentials(
        ...
        """Extracts the user credentials and returns user email and password as strings."""
    ...
    def user_object_from_credentials(
        ...
        """Retrieves a User instance from the provided email."""
